            ...
            children: [
              ...
              GlassCard(
                child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
                  ...
                  const SizedBox(height: 16),
                  _ControlRow(icon: Icons.power_settings_new, label: 'Camera Power',
                      value: camera.status != CameraStatus.offline, onChanged: (_) => ctrl.toggleCamera(id)),
                  const Divider(color: AppTheme.surface2, height: 20),
                  _ControlRow(icon: Icons.motion_photos_on_outlined, label: 'Motion Detection',
                      value: camera.motionEnabled, onChanged: (_) => ctrl.toggleMotion(id)),
                  const Divider(color: AppTheme.surface2, height: 20),
                  _ControlRow(icon: Icons.fiber_manual_record, label: 'Recording',
                      value: camera.isRecording, onChanged: (_) {}),
                ]),
              ),
